 ...
 * @author jvalv
 */
public class DesafioProWay extends javax.swing.JFrame {

    /**
     * Creates new form DesafioProWay
     */
    public DesafioProWay() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        menuCadastro.setText("Tratamento dos Jogos ");
        menuCadastro.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuCadastroActionPerformed(evt);
            }
        });
        menuJogos.add(menuCadastro);

        barraMenu.add(menuJogos);
    ...
    private void menuCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuCadastroActionPerformed
        JogosView tabela = new JogosView();
        areaTrabalho.add(tabela);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DesafioProWay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DesafioProWay().setVisible(true);
            }
        });
    }
